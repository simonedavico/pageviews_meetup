defmodule PageviewsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PageviewsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PageviewsWeb.Gettext, "errors", msg, opts)
    # end
