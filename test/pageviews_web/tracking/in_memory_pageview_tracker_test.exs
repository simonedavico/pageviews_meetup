defmodule PageviewsWeb.Tracking.InMemoryPageviewTrackerTest do
  use PageviewsWeb.ConnCase, async: false

  alias Pageviews.Repo
  alias Pageviews.Tracking.PageView
  alias PageviewsWeb.Tracking.InMemoryPageviewTracker
